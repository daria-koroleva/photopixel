...
class MyAccountManager(BaseUserManager):
    ...
    def create_user(self, email, username,
                    profilePhotoFileName, password=None):
        if not email:
...
class Account(AbstractBaseUser):
    ...
    profilePhotoFileName = models.CharField(
        max_length=100, default='profilePicFileName', blank=True)
...
class Follow(models.Model):
    ...
    following = models.ForeignKey(
        Account, related_name='followings', on_delete=models.CASCADE)
